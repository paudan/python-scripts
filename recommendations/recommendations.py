# Example from Programming Collective Intelligence, Chapter 2
    ...
    for other in prefs:
        ...
        for item in prefs[other]:
            ...
            if item not in prefs[person] or prefs[person][item] == 0:
                ...
                totals[item] += prefs[other][item] * sim  # Similarity * Score
                # Sum of similarities
...
def main():
    ...
    print(top_matches(critics, 'Toby', similarity=sim_distance))
